...
st.markdown("<h1 style='text-align: center;'>☁️ Identifikasi Peluang Optimasi Biaya Cloud AWS PT Jalin Mayantara pada Februari 2025 ☁️ ️</h1>", unsafe_allow_html=True)
